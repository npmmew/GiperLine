...
function LoginForm() {
    ...
    const [passwordError, setPasswordError] = useState('поле Паоль не может быть пустым')
    ...
    return (
      <div className="h-screen w-screen flex items-center justify-center">
          <form action="" className="flex flex-col w-[400px] p-10 shadow-2xl">
            ...
            <input className="rounded p-3 border mb-3 focus:border-blue-700 focus:border-2" name="email" type="text" placeholder="Введите свой email"/>
            <input className="rounded p-3 border focus:border-blue-700 focus:border-2" name="password" type="password" placeholder="Введите свой пароль"/>
